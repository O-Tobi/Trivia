...
//Easy will have 10 questions and 20 seconds to answer each
//Medium will have 20 questions with 15 seconds to answer each
//Hard will have 40 questions with 10 seconds to answer each
